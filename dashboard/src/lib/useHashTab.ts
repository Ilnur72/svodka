...
export const TABS: { id: TabId; label: string }[] = [
  ...
  // «Кадрлар режаси» нинг ЁНИДА, чунки учови ҳам БОШҚАРМА ҳужжати: битта
  // XLSX'нинг жорий ҳолати, ой кесимидаги вақт қатори эмас. Шунинг учун
  // юқоридаги давр танлагичи учовига ҳам таъсир қилмайди.
  //
  // ⚠️ «Лойиҳалар реестри», «Лойиҳалар паспорти» ва «Инвестиция…» таблари
  // билан адашмасин: улар ҳаммаси ЛОЙИҲА ҳақида (қиймат, молиялаштириш,
  // бажарилиш %) ва бир-бирига ўхшаш. Булар эса лойиҳа ҳақида ЭМАС:
  //
  //   бу таб — ҲУҚУҚИЙ иш юритиш: 23 суд иши (даъво мазмуни, суд номи,
  //            юрист, ҳал қилув натижаси), 2 претензия ва 10 шартнома
  //            экспертизаси. Учта варақнинг устунлари `Т/р` дан бошқа жойда
  //            умуман кесишмайди, шунинг учун бўлим ичида ҳам улар учта
  //            алоҳида рўйхат бўлиб қолади.
  //
  // Алоҳида бэкенд модули — `legal-affairs`.
  { id: "legal", label: "Юридик бошқарма" },
  // «Юридик бошқарма» нинг ЁНИДА ва у билан бир хил манба турида (бошқарма
  // XLSX'и), лекин мазмуни умуман кесишмайди: у — ҳуқуқий иш юритиш, бу эса
  // ХАРИД ҲАЖМЛАРИ: 10 харид тури × 8 давр слоти (6 чорак + 2 «умумий»),
  // ҳар бир катакда сони, шартнома суммаси ва тасдиқланган ТМБ.
  //
  // ⚠️ «Сотиш ва қолдиқлар (СГП)» ва «Экспорт кўрсаткичлари» билан ҳам
  // адашмасин: улар СОТУВ томони (маҳсулот сотилиши, экспорт мақсадлари),
  // бу эса САТИБ ОЛИШ томони. Алоҳида бэкенд модули — `state-procurement`.
  { id: "procurement", label: "Давлат харидлари 2025–2026" },
