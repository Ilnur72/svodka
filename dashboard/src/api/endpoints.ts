 ...
 * тўлиқ манзарани кўрсатмай қоларди. Ҳозирги ҳолат: 192 объект (2 завод,
 * 46 геология, 144 реестр лойиҳаси), жавоб ҳажми ~764 КБ. `?investType=`
 * эса энди натижани ТОРАЙТИРМАЙДИ (`meta.filters.investTypeApplies: false`):
 * `invest` қатлами лойиҳалар реестридан келади, унда тасниф устуни йўқ.
 *
