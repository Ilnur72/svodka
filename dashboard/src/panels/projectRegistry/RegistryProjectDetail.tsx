 ...
 *
 * Сурат манзили базадаги `image` устунидан келади (`registry/094.jpg`) ва
 * 144 лойиҳадан 44 тасида бор. Қолган 100 тасида у `null` — бу ХАТО ЭМАС,
 * шунинг учун блокда «сурат юкланмаган» эмас, «бу лойиҳа учун сурат йўқ»
 * плашкаси туради. Иккови фарқланишини `AreaPhoto` таъминлайди; ҳар икки
 * ҳолатда ҳам остидаги кўрсаткичлар реестрдан олинади ва суратга умуман
 * боғлиқ эмас.
 *
    ...
    >
      ...
      <div className={GRID.g3 + " mt-3"}>
        ...
        {/* ўрта: сурат ва лойиҳа майдони.
            ...
            `key` манзилдан: лойиҳа алмашганда `AreaPhoto` нинг юклаш ҳолати
            ноль ҳолатдан бошлансин. Сурати йўқ лойиҳада манзил `null` —
            унда `key` лойиҳа id'сидан ясалади, чунки `key={null}` React учун
            «калит йўқ» дегани ва кетма-кет икки лойиҳа битта элемент бўлиб
            қолиб кетарди. */}
        <div className="min-w-0">
          <AreaBlock key={d.area.src ?? `no-photo-${p.id}`} area={d.area} />
        </div>
