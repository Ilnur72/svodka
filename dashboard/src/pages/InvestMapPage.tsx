 ...
 * `GET /map/objects`: **55 объект**, уччала қатлам аралаш (заводлар,
 * геология лойиҳалари, инвестиция лойиҳалари).
 *
 ...
 *
 *   1. **Координатаси йўқ объект** (жонли жавобда 8 та) — харитада нуқта
 *      бўлолмайди. У пастдаги рўйхатда алоҳида гуруҳда туради;
 ...
 * ═══ Нега керак ═════════════════════════════════════════════════════════
 *
 * Харитада 55 объект бор, ёрлиқлар эса тўқнашганда яширилади (қаранг:
 ...
 * боғлиқ эмас.
 *
 * Устига координатаси йўқ объектлар (жонли жавобда 8 та) фақат шу ерда
