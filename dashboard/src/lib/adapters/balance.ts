 ...
 *  - занжирлар металл бўйича **гуруҳланади**, чунки битта металл бир нечта
 *    мустақил занжирдан келади ва улар бирлаштирилмайди. Волфрам иккита:
 *    Ингичка (отвал → концентрат → жўнатиш) ва Чирчиқ (WO3 → штабик, порошок,
 *    ферровольфрам, карбид) — ҳар бирида босқич рақами 1 дан бошланади,
 *    якуний тугун йўқ, шунинг учун улар шунчаки кетма-кет чизилади. Рений
 *    иккита сайтдан келади (ГТЦ Навоий ва ГТЦ-1) ва иккаласи ҳам якуний
 *    тугунга (`RE_TOTAL`) стрелка билан уланади;
