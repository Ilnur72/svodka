  ...
  return (
    <>
      {/* --- 1. БОШ РАҚАМЛАР: йиллар кесими ----------------------------------
          Юқоридаги манба банери (файл, варақ, импорт санаси) фойдаланувчи
          талаби билан олиб ташланган. Ундаги ИККИ мазмунли жумла йўқолмади:
            · «чораклардан ҳисобланган, манбанинг ўз йиғиндиси қўшилмайди» —
              у аллақачон шу бўлим ва «Чораклар динамикаси» / «Харид турлари»
              карточкаларининг `note` ларида турибди, такрори керак эмас;
            · ёнидаги «Юридик бошқарма» таби билан фарқи — шу қуйидаги
              `note` га кўчирилди. */}
      <Section
        title="Харидлар — йиллар кесими"
        note="харид ҳажмлари (ёнидаги «Юридик бошқарма» — ҳуқуқий иш юритиш) · чораклардан ҳисобланган, манбанинг ўз йиғиндиси ёнида текширилади"
      >
        <div className={GRID.g2}>
          {v.years.map((y) => (
