...
export const TABS: { id: TabId; label: string }[] = [
  ...
  // қамрови бошқа — у жорий реестр (қиймат, молиялаштириш, ижро фоизи),
  // бу эса 2026–2030 йиллар дастурининг тақдимоти: 88 лойиҳа, кластерлар
  // кесимида, ҳар бири ўз KPI, иш режаси ва молия жадвали билан. Алоҳида
  // бэкенд модули — `invest-deck`.
  { id: "investdeck", label: "Инвестиция дастури 2026–2030" },
  // ⚠️ «Инвестиция дастури 2026–2030» нинг ЁНИДА ва у билан ЖУДА ўхшаш: 88
  // лойиҳадан 82 таси шу реестрда ҳам бор, кўпи белги-ма-белги бир хил. Иккови
  // ҳам атайин сақланади, чунки булар икки ХИЛ ҲУЖЖАТ:
  //
  //   манбаси  — у: PPTX тақдимот (03.08.2026); бу: XLSX реестр (16.09.2026);
  //   қамрови  — у: 88 лойиҳа; бу: 144 лойиҳа, 9 кластер, 17 йўналиш;
  //   мазмуни  — у: ҳар лойиҳанинг KPI'си, иш режаси ва йиллар бўйича молия
  //              жадвали; бу: ОПЕРАЦИОН ҳолат — бажарилиш %, ТИА ва қурилиш
  //              ҳужжатлари, инфратузилма, ишга тушириш санаси, масъул шахс.
  //
  // Бирлаштириш иккала ҳужжатнинг ҳам ўз ҳақиқатини йўқотарди (қайси сана,
  // қайси рўйхат?), шунинг учун улар ёнма-ён яшайди ва фарқи табнинг ичида
  // ҳам, экраннинг юқорисида ҳам ёзиб қўйилган. Алоҳида бэкенд модули —
  // `project-registry`.
  { id: "registry", label: "Лойиҳалар реестри · 16.09.2026" },
  // «Сотиш ва қолдиқлар (СГП)» билан адашмасин: у — ойлик амалдаги сотув ва
  // омбор қолдиғи, бу эса 2024–2030 йиллар бўйича экспортнинг МАҚСАДЛИ
  // кўрсаткичлари (8 маҳсулот × 8 давр), манбаси алоҳида ҳужжат —
  // «1.1 Рынок - экспорт 2024-2030.xlsx», алоҳида бэкенд модули
  // (`export-targets`). Ёнидаги «Инвестиция дастури» каби вақт қатори эмас.
  { id: "exporttargets", label: "Экспорт кўрсаткичлари 2024–2030" },
  // «Инвестиция дастури» ёнида: иккови ҳам келажак лойиҳалари, лекин бу —
  // ҳар бир лойиҳанинг иш графиги (Gantt: босқич, иш, муддат, масъул),
