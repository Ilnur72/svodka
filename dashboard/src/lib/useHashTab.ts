...
export const TABS: { id: TabId; label: string }[] = [
  ...
  // «Инвестиция лойиҳалари» ёнида: манбаси айнан битта реестр, лекин кўриниши
  // бошқа — у жадвал ва паспорт, бу эса харита: ҳар бир лойиҳа фон харитасида
  // ўз нуқтасида туради ва босилганда ўз карточкасини очади. «Геология
  // лойиҳалари» ичидаги харита билан ҳам адашмасин: у вилоят SVG контури ва
  // вилоятдаги лойиҳалар СОНИ, бу эса аниқ нуқта ва алоҳида лойиҳа.
  { id: "investmap", label: "Лойиҳалар харитаси" },
