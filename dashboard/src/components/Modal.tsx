 ...
 * (`md` — тасдиқлаш саволлари, `lg` — «Инвестиция дастури» тафсилоти).
 *
 ...
 *
 * `2xl` реестр лойиҳасининг тафсилоти учун: у «Инвестиция лойиҳалари»
 * паспорти билан бир хил шаблонда — УЧТА устун ёнма-ён (`GRID.g3`).
 * 1180px да мазмун идиши 1148px бўлиб, ҳар бир устунга ≈373px қоларди ва
 * «Молиялаштириш» қаторидаги ном+сон жуфти иккига синарди; 1440px да
 * устун ≈460px — паспорт бўлимидагига яқин. Бу ҳам ЮҚОРИ чегара, шунинг
 * учун кичикроқ экранда ойна ўзидан кенг бўлиб кетмайди.
 */
const WIDTH: Record<"md" | "lg" | "xl" | "2xl", string> = {
  md: "max-w-[620px]",
  lg: "max-w-[900px]",
  xl: "max-w-[1180px]",
  "2xl": "max-w-[1440px]",
