 ...
 * янгиси қўйилади). («Молиявий кўрсаткичлар» бўлими бошида худди шундай
 * статик модулга таянган эди, лекин энди `finance-report` бэкенд модулидан
 * келади — қаранг: `lib/adapters/finance.ts`.)
 *
